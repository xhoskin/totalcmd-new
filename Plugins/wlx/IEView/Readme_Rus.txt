...
- багфиксы
1.94 (18.06.2005)
- Убраны ключи: NoFocusChange, BlockParentDir
- Добавлены ключи: [Extensions]->WordToHTML, [Extensions]->WordToMHT, [options]->StatusBarInQuickView,
  [options]->SavePositionOnExit, [options]->AllowPopups.
- Добавлен хоткей SavePosition
- Файлы Word открываются read-only
- багфиксы 
1.94a (14.07.2005)
- багфиксы 
- Ключи FocusByWindowClass, UseMiddleWhenFocusByPoint перенесены в секцию [Debug]
